      ...
      <header className="sticky top-0 z-50 bg-white/70 backdrop-blur-xl border-b border-slate-200 shadow-[0_2px_10px_rgba(0,0,0,0.02)]">
        <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-6">
            <div className={`flex items-center gap-2 text-xs font-medium px-3 py-1 rounded-md border ${backendOnline
      ...
      <main className="relative z-10 max-w-7xl mx-auto px-6 py-12">
        ...
        <div className="mb-10">
          ...
          <p className="text-slate-500 text-sm max-w-2xl leading-relaxed">
            请输入待检测的新闻文本及图片，系统将利用深度神经网络提取新闻特征，自动判定内容的真实性并提供可解释性分析。
          </p>
        </div>
